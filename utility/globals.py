...
parser.add_argument("--data_prefix",default="./data/toy",type=str,help="prefix identifying training data")
parser.add_argument("--fold",default="1",type=str,help="k-fold")
parser.add_argument("--dir_log",default=".",type=str,help="base directory for logging and saving embeddings")
parser.add_argument("--gpu",default="-1",type=str,help="Whether use GPU")
parser.add_argument("--eval_train_every",default=15,type=int,help="How often to evaluate training subgraph accuracy")
parser.add_argument("--train_config",default="./train_config/toy.yml",type=str,help="path to the configuration of training (*.yml)")
